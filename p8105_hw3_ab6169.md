...
![](p8105_hw3_ab6169_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](p8105_hw3_ab6169_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->
Comments:
...
![](p8105_hw3_ab6169_files/figure-gfm/unnamed-chunk-20-1.png)<!-- -->
Comments: The plot shows how total daily activity varies with age and
education level for men and women. Among participants with less than a
high school education, males generally have slightly higher total
activity than females across most ages. But, both groups show a gradual
decline in activity with age. For those with a high school equivalent or
more than high-school education, females showcase higher total activity
than males. The female lines remain consistently above the male lines in
these two panels. This suggests to me that there is greater daily
movement among more educated women.
...
![](p8105_hw3_ab6169_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
Comments:

This plot shows daily patterns across all education levels. Activity
levels are lowest during nighttime hours, such as 0–400 and 1200–1440. I
see that activity peaks in the morning and also the afternoon. Across
all three panels, I can see that men and females follow similar daily
patterns, but there are some minor differences. In the less than high
school group, I observed that men show slightly higher early morning
peaks. Meanwhile, in the high school equivalent and more than high
school groups, women display higher afternoon activity levels.
